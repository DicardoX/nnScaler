...
from external.nnscaler.ir.unique import IDGenerator
from external.nnscaler.ir.operator import IRBpOperation, IRFwOperation, IRDataOperation
from external.nnscaler.ir.tensor import IRFullTensor, IRSubTensor, ValueMap

from external.nnscaler.graph.function.function import Identity
from external.nnscaler.graph.function.anchor import IRGraphAnchor
from external.nnscaler.graph.function.pyfunc import IRPyFunc
from external.nnscaler.graph.function.dimops import IRDimops, OpAnno
from external.nnscaler.graph.segment import IRSegment
...
class IRGraph(IRSegment):
    ...
    def forward(self, *args: Tuple[IRObject]) -> Union[IRTensor, Tuple[IRTensor]]:
        ...
        from external.nnscaler.program import Program
    ...
    def fuse(self, nodes: List[IRFwOperation],
        ...
        if make_customized_op:
            from .parser.register import CustomizedOps
    ...
    def _bind_schedule(self, schedplan):
        ...
        Returns:
            None
        """
        from .schedule.schedplan import SchedulePlan
